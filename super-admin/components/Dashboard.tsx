    ...
    <div className="grid grid-cols-12 gap-4 md:gap-6 2xl:gap-7.5">
      ...
      {/* Promo/Ad Space */}
       <div className="hidden lg:block lg:col-span-4">
         <div className="h-full w-full rounded-xl border border-indigo-100 bg-gradient-to-br from-indigo-600 to-violet-700 p-6 shadow-sm text-white flex flex-col justify-between">
            <div>
